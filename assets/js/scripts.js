...
PAGE JS
*===================================*/
// const groups = document.querySelectorAll("#group-1, #group-2, #group-3, #group-4, #group-5");
// const buttons = document.querySelectorAll("#button-1, #button-2, #button-3, #button-4, #button-5");
